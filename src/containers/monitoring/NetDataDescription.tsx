        ...
        return (
            <div>
                ...
                <p>
                    ...
                    current image of NetData embeded in Athena uses a default
                    configuration for
                    <NewTabLink url="https://docs.netdata.cloud/docs/anonymous-statistics/">
                        &nbsp;statistics
                    </NewTabLink>
                    . You can recompile Athena with a different customized
                    image if you'd like.
                </p>
                <p>
                    Athena provides a simple interface to enable NetData on
                    your Athena instance. Currently, Athena only supports
                    installing NetData on your <b>leader node</b>, i.e., the
                    node where Athena instance resides. This limitation is due
